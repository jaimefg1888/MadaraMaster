#!/usr/bin/env python3
# MadaraMaster — log de auditoría forense
# jaimefg1888
...
class AuditLogger:
    ...
    def log_wipe_operation(self, file_path: Path, file_size: int, sha256_before: str, standard_used: str, result: Dict[str, Any]):
        # guarda cada operación en formato JSON Lines para cumplimiento normativo
        try:
            record = {
            ...
            logging.error(f"Error escribiendo en el log de auditoría: {e}")

    def get_logs(self):
        # generador para leer el log línea a línea sin cargar todo en memoria
